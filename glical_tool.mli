...
val extract_assocs :
  ?kl:Glical.key list ->
  ?ks:SSet.t ->
  ([> `Raw of Glical.location * string ] as 'a) Glical.Ical.t ->
  'a Glical.Ical.t
...
val extract_values :
  ?kl:Glical.key list ->
  ?ks:SSet.t ->
  ([> `Raw of Glical.location * string ] as 'a) Glical.Ical.t -> 'a list

(**  *)
val list_keys_rev :
  [> `Raw of Glical.location * string ] Glical.Ical.t -> string list
...
val combine :
  ([> `Raw of Glical.location * string ] as 'a) Glical.Ical.t ->
  'a Glical.Ical.t -> 'a Glical.Ical.t
